$(document).on("submit", ".form_registro", function(event){
    ...
    $("#msg_error").hide(); // PARA OCULTAR CAPA ANTERIOR
    var url_php = 'http://localhost/login_pi/ajax/procesar_registro.php';
...
$(document).on("submit", ".form_login", function(event){
    ...
    $("#msg_error").hide(); // PARA OCULTAR CAPA ANTERIOR
    var url_php = 'http://localhost/login_pi/ajax/procesar_login.php';
